...
and the latter introduces severe performance degradation. If want it regardless,
...
M-x xterm-coor-test-raw then M-: (ansi-color-apply-on-region (point-min) (point-max))
